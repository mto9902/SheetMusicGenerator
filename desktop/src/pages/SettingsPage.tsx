    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="card card--centered">
          <p className="text-sm text-[#8E8E93]">Loading settings...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="page max-w-3xl mx-auto">
        <header className="page__header">
          ...
          <div className="page__actions">
            <button type="button" className="btn-primary px-5 py-2.5" onClick={handleSave}>
              Save settings
            </button>
          </div>
        </header>
        ...
        <section className="card">
          ...
          <div className="flex flex-col gap-0 mt-2">
            <label className="toggle-row">
              ...
              <input
                type="checkbox"
                className="w-[22px] h-[22px] accent-[#2C2C2E] shrink-0"
